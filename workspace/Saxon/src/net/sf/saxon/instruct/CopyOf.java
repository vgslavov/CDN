...
public class CopyOf extends Instruction implements DivisibleInstruction {
                ...
                switch (kind) {
                    ...
                    case Type.DOCUMENT: {
                        ...
                        if (copyLineNumbers) {
                            ...
                            val.getPipelineConfiguration().setCopyInformee(copier);
                        }
                        try {
    ...
    public SequenceIterator iterate(final XPathContext context) throws XPathException {
        if (schemaType == null && copyNamespaces && !copyForUpdate) {
            if (validation == Validation.PRESERVE) {
                ...
                return new ItemMappingIterator(select.iterate(context), copier, true);
    ...
    public void processRight(Stack<XPathContext> contextStack, Stack state) throws XPathException {
        ...
        while (true) {
            ...
            out.append(i, 0, NodeInfo.ALL_NAMESPACES);
        }
    }
}
