        ...
        if (!itemTypeOK) {
            ...
            if (reqItemType.isAtomicType()) {
                ...
                if (!(suppliedItemType.isAtomicType()) &&
                    ...
                    Expression cexp = new Atomizer(exp).simplify(visitor);
            ...
            } else if (reqItemType instanceof FunctionItemType) {
                ...
                // Apply function coercion as defined in XQuery 1.1

                exp = ((FunctionItemType)reqItemType).makeFunctionSequenceCoercer(exp, role, visitor);
                itemTypeOK = true;
            }
