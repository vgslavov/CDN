...
public abstract class StandardNames {
    ...
    public static final int XS_MIN_EXCLUSIVE = XS + 94;
    public static final int XS_MIN_INCLUSIVE = XS + 95;
    public static final int XS_MIN_LENGTH = XS + 96;
    public static final int XS_notation = XS + 97;
    public static final int XS_OPEN_CONTENT = XS + 98;
    public static final int XS_OVERRIDE = XS + 99;
    public static final int XS_PATTERN = XS + 100;
    public static final int XS_REDEFINE = XS + 101;
    public static final int XS_RESTRICTION = XS + 102;
    public static final int XS_SCHEMA = XS + 103;
    public static final int XS_SELECTOR = XS + 104;
    public static final int XS_SEQUENCE = XS + 105;
    public static final int XS_SIMPLE_CONTENT = XS + 106;
    public static final int XS_SIMPLE_TYPE = XS + 107;
    public static final int XS_EXPLICIT_TIMEZONE = XS + 108;
    public static final int XS_TOTAL_DIGITS = XS + 109;
    public static final int XS_UNION = XS + 110;
    public static final int XS_UNIQUE = XS + 111;
    public static final int XS_WHITE_SPACE = XS + 112;
