...
public class FormatNumber extends SystemFunction {
    ...
    // TODO: fails messily if called from within saxon:evaluate(). Same might apply to other XSLT functions. The
    // spec says it's not supported, but it isn't properly prevented either.
