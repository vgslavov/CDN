...
public class DOM4JObjectModel extends TreeModel implements ExternalObjectModel, Serializable {
    ...
    private Object convertXPathValueToObject(Value value, Object targetClass) {
        if (value instanceof SingletonItem) {
            NodeInfo n = (NodeInfo)((SingletonItem)value).getItem();
            if (n instanceof VirtualNode) {
                Object u = ((VirtualNode)n).getRealNode();
    ...
    public DocumentInfo wrapDocument(Object node, String baseURI, Configuration config) {
        ...
        return new net.sf.saxon.option.dom4j.DocumentWrapper(documentNode, baseURI, config);
    }
